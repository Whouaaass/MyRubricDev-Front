...
const Button: React.FC<ButtonProps> = ({
  ...
  const baseClasses =
    'px-4 py-2 min-h-11 rounded-xl hover:-translate-y-0.5 hover:shadow-md font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 transition-all duration-200'
  const variants = {
    primary:
