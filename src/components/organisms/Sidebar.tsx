...
const Sidebar: React.FC<SidebarProps> = ({ appName, logo }) => {
  const { sidebarExpanded, toggleSidebar, setSidebarExpanded, isMobile } = useLayoutStore();
  ...
  return (
    <aside
      ...
      `}
    >
      <SidebarHeader appName={appName} logo={logo} expanded={sidebarExpanded} isMobile={isMobile} toggle={toggleSidebar} />
